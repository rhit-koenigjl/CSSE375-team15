...
public class EnemyGenerator extends EnemySpawner {
  ...
  EnemyGenerator(double startX, double startY, double width, double height, List<Enemy> enemies,
      Player player) {
    this(startX, startY, width, height, 0, 0, enemies, player);
  }

  EnemyGenerator(double startX, double startY, double width, double height, double velocityX,
