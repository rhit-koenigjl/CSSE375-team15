...
public class TestLevelLoader {
    ...
    public void testLevelLoader_createLevel_expectFiveBlocksFiveEnemies() {
        LevelLoader testLoader = new LevelLoader("src\\main\\resources\\levels\\testLevels\\test55.json");
        testLoader.loadLevel();
    ...
    public void testLevelLoader_createLevel_expectSpikes () {
        LevelLoader testLoader = new LevelLoader("src\\main\\resources\\levels\\testLevels\\spike_test.json");
        assertEquals(0, testLoader.getTiles().size());
        testLoader.loadLevel();
    ...
    public void testLevelLoader_createLevel_expectHunterSeekers () {
        LevelLoader testLoader = new LevelLoader("src\\main\\resources\\levels\\testLevels\\hunter_seeker_test.json");
        assertEquals(0, testLoader.getEnemies().size());
        testLoader.loadLevel();
    ...
    public void testLevelLoader_createLevel_expectCoins () {
        LevelLoader testLoader = new LevelLoader("src\\main\\resources\\levels\\testLevels\\coin_test.json");
        assertEquals(0, testLoader.getTiles().size());
        testLoader.loadLevel();
