...
public class Player extends Actor {
	...
	//e.g. 5 means each frame the displacement between the velocity and max speed will be reduced by 1/5
	...
	/**
	 * ensures the general running of the player class including moving the player, and calling the controll() and handleCollision() methods
	 * @param keys
	 * @param tiles
	 */
